...
$q = "select * from tbl_patient where id=$_GET[id]";
      ...
      ?>
        ...
        <div class="main">
            ...
            <form method="post" enctype="multipart/form-data">
                <input type="text" placeholder="Enter Patient Name" name="name" value="<?php  echo $r['name']?>" > <br><br>
                <input type="number" placeholder="Enter patient Number" name="phone" value="<?php  echo $r['contact']?>"> <br><br>
                ...
                <input type="email" placeholder="Enter patient Email" name="email" value="<?php  echo $r['email']?>"> <br><br>
                <select name="gender" >
                    <option hidden>select any gender</option>
                    <option value="male">Male</option>
                    <option value="female">Female</option>
                </select><br><br>
                <input type="text" placeholder="Enter patient password" name="password" value="<?php  echo $r['password']?>"> <br><br>
                <input type="text" placeholder="Enter patient Address" name="address" value="<?php  echo $r['address']?>"> <br><br>
            ...
            if(isset($_POST['btnadd']))
            {
                ...
                $gender = $_POST['gender'];
                $qry ="update tbl_patient set name='$name',contact='$phone',cid='$city',email='$email',password='$password',address='$address', gender='$gender' where id = $_GET[id] ";
            ...
            <div class="rightside">
                ...
                <form method="post" enctype="multipart/form-data">
                    ...
                    if(isset($_POST['submitt']))
                    {
                      ...
                      $qr ="update tbl_patient set image='$path' where id = $_GET[id]";
