    ...
    <section class="main">
        <div class="form">
            ...
            <form method="post" autocomplete="off">
                ...
                <input type="submit" value="Signup" name="btnlogin">
            </form>
            <div class="text">
            <a href="login.php">Already Register? Login</a></div>
            <?php
            if(isset($_POST['btnlogin']))
            {
                ...
                $query = "insert into tbl_hospitals(name,email,password) values ('$name','$email','$password')";
